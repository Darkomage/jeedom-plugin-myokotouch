 ...
 * - 'generic'  : type générique Jeedom (clé = variable pour la commande info,
 *                variable + '_set' pour la commande action). Absent = aucun type.
 */
return [
    'hk' => [
        'standard' => [
        ...
        'generic' => [
            // Circuit de chauffage exposé comme thermostat (app mobile, Homebridge, Google…)
            'L_roomtemp_act' => 'THERMOSTAT_TEMPERATURE',
            'temp_heat'      => 'THERMOSTAT_SETPOINT',
            'temp_heat_set'  => 'THERMOSTAT_SET_SETPOINT',
            'mode_auto'      => 'THERMOSTAT_MODE',
            'mode_auto_set'  => 'THERMOSTAT_SET_MODE',
            'L_statetext'    => 'THERMOSTAT_STATE_NAME',
        ],
    ],
    'ww' => [
        ...
        'generic' => [
            'L_ontemp_act'  => 'TEMPERATURE',
            'L_pump'        => 'HEATING_STATE',
            'mode_auto'     => 'MODE_STATE',
            'mode_auto_set' => 'MODE_SET_STATE',
        ],
    ],
    'pe' => [
        'standard' => [
        ...
        'generic' => [
            'L_temp_act'      => 'TEMPERATURE',
            'L_br'            => 'HEATING_STATE',
            'L_pellets_today' => 'DAILY_CONSUMPTION',
            'mode'            => 'MODE_STATE',
            'mode_set'        => 'MODE_SET_STATE',
        ],
    ],
    'system' => [
        'standard' => [
